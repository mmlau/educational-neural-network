...
# We give a list of 4 random numbers between 0 and 2.
# We expect the largetst of those numbers
def condition(a):
    return max(a)


# Now define the dimensions:
# We need 4 input neurons
nr_input_neurons = 4
...
raw_input = np.random.randint(3, size=(nr_input_data, nr_input_neurons))
output = []
